...
//Constructor
GraphicsLib::GraphicsLib(float screenSizeX, float screenSizeY)
{
...
void GraphicsLib::render()
{
	//Flip display buffers
	al_flip_display();
}

void GraphicsLib::loadImage(std::string imageFilePath, std::string imageIdentifier)
{
...
void GraphicsLib::drawImage(std::string imageIdentifier, float posX, float posY)
{
...
void GraphicsLib::drawTintedImage(std::string imageIdentifier, float posX, float posY, Color col)
{
	//Find the image and draw if it exists
	std::vector<std::pair<std::string, ALLEGRO_BITMAP*>>::iterator iterator;
