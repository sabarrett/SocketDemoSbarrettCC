    ...
    else if(event.getType() == MOUSE_ACTION_EVENT)
    {
        ...
        if(mouseEvent.getButtonState() == BUTTON_DOWN)
        {
            ...
            if(mouseEvent.getMouseButton() == 0)
	        {
                ...
                TCPNetworkManager::getInstance()->sendPacket(Packet_Header::FIRE_PROJECTILE, data, sizeof(id) + sizeof(mouse), true);
            ...
            if (mouseEvent.getMouseButton() == 1)
            {
                ...
                if (u)
                {
                    ...
                    {
                        TCPNetworkManager::getInstance()->sendPacket(Packet_Header::OBJECT_DELETE, (char*)&id, sizeof(int), true);
